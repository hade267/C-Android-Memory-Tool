...
bool ImGui_init() {
    ...
    printf("ImGui_ImplAndroid_Init...\n");
    ImGui_ImplAndroid_Init(native_window);
    
    printf("ImGui_ImplOpenGL3_Init...\n");
    ...
    g_Initialized = true;
    printf("ImGui_init finished\n");
    return true;
}

void drawBegin() {
    // printf("drawBegin: screen_config\n");
    screen_config();
...
void drawEnd() {
    ...
    // printf("drawEnd: ImGui::Render\n");
    ImGui::Render();
    
    // printf("drawEnd: ImGui_ImplOpenGL3_RenderDrawData\n");
    ImGui_ImplOpenGL3_RenderDrawData(ImGui::GetDrawData());
    
    // printf("drawEnd: eglSwapBuffers...\n");
